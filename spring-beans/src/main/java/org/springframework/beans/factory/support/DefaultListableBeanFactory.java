 ...
 *
 * @see #beanDefinitionMap	注册表，由 BeanDefinition 的标识 （beanName） 与其实例组成
 * @see #beanDefinitionNames		标识（beanName）集合
 * @see #registerBeanDefinition   向IOC容器注册解析的BeanDefiniton
 */
...
public class DefaultListableBeanFactory extends AbstractAutowireCapableBeanFactory implements ConfigurableListableBeanFactory, BeanDefinitionRegistry, Serializable {
	...
	//---------------------------------------------------------------------
	/**
	 * 核心一句话	this.beanDefinitionMap.put
