...
public class AnnotatedBeanDefinitionReader {
	 ...
	 *
	 * @步骤
	 * a、使用注解元数据解析器解析注解Bean中关于作用域的配置。
	 * 	@see AnnotationScopeMetadataResolver#resolveScopeMetadata
	 * b、处理注解Bean定义类中通用的注解
	 *  @see AnnotationConfigUtils#processCommonDefinitionAnnotations	处理注解bean定义类中的通用注解
	 * C、根据注解Bean定义类中配置的作用域为其应用相应的代理策略
	 *  @see AnnotationConfigUtils#applyScopedProxyMode
	 * d、向容器注册Bean 。
	 *  @see BeanDefinitionReaderUtils#registerBeanDefinition
	 */
